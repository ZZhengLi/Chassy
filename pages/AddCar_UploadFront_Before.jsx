  ...
  return (
    <>
      ...
      <div class = "align-content: center flex flex-col space-y-4">
        <Image src={Step2} width={250} alt="step2" class = "mx-auto max-w-lg h-auto" />
      </div>
      <div class="text-center font-prompt text-[14px]">
        <Image src={Car} width={150} class="max-w-full h-auto rounded-lg text-center font-prompt text-[14px]"/>
...
Upload a picture of the front of the car to clearly see the license
      ...
      <div class = "flex items-center justify-center ">
        <button class="bg-[#789BF3] text-[#789BF3] text-slate-400 hover:bg-[#789BF3] bg-opacity-10 font-bold text-blue py-2 px-4 rounded items-center" onClick={() => router.push("/AddCar_Qr")}>Back</button>
        <button class="bg-[#789BF3] hover:bg-[#789BF3] text-white font-bold py-2 px-4 rounded items-center" onClick={() => router.push("/AddCar_UploadFront_After")}>
          Next
        </button>
      </div>

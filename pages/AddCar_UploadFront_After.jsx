...
export default function AddCar_UploadFront_After() {
  ...
  return (
    <div class = "flex flex-col space-y-4">
      ...
      <div  class ="align-content: center">
        <Image src={Car} width={250} alt="car" class="max-w-full h-auto rounded-lg ml-6" />
      </div>
      <div>
        <div class = "flex flex-col space-y-2 ...">
          <p class="text-left font-prompt text-[14px]">Registration number</p>
          <input></input>
        <p class="text-left font-prompt text-[14px] text-[14px] ml-30">Edit</p>
        <i className="fas fa-cat">icon</i>
      </div>
        <div class = "flex flex-col space-y-2 ...">
          <p class="text-left font-prompt text-[14px]">Brand: Honda</p>
          <input></input>
        </div>
        <div class = "flex flex-col space-y-2 ...">
          <p class="text-left font-prompt text-[14px]"> Model: Jazz</p>
          <input></input>
        </div>
        <div class = "flex flex-col space-y-2 ...">
      ...
      <div class = "flex items-center justify-center">
        ...
        <button class="bg-[#789BF3] hover:bg-[#789BF3] text-white font-bold py-2 px-4 rounded items-center" onClick={() => router.push("/AddCar_UploadEvidence")}>
          Next
        </button>
      </div>
      <div>
